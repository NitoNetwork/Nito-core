...
"""Verify that starting nito with -h works as expected."""

from test_framework.test_framework import NitoTestFramework
from test_framework.util import assert_equal

class HelpTest(NitoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nito with -h for help text")
        ...
        self.log.info("Start nito with -version for version information")
        ...
        self.log.info("Start nitod with -fakearg to make sure it does not start")
