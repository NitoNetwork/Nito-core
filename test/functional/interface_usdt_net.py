...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/nito/nito/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(NitoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our nitod node")
