...
class TestShell:
    """Wrapper Class for NitoTestFramework.

    The TestShell class extends the NitoTestFramework
    ...
    class __TestShell(NitoTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by NitoTestFramework child class.
            self.num_nodes = 1
