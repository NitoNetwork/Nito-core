...
Verify that a nitod node can use an external signer command.
...
class RPCSignerTest(NitoTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart nitod with -signer=<cmd>',
