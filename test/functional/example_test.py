...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NitoTestFramework
    pass


class ExampleTest(NitoTestFramework):
    # Each functional test is a subclass of the NitoTestFramework class.
    ...
    def custom_method(self):
        ...
        NitoTestFramework class so other tests can use it."""
