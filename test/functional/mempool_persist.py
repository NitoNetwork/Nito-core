...
By default, nitod will dump mempool on shutdown and
...
class MempoolPersistTest(NitoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent nitod from writing mempool.dat to disk. Verify that `savemempool` fails")
