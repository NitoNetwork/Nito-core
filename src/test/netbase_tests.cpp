...
{
    BOOST_CHECK(TestSplitHost("www.nitocore.org", "www.nitocore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.nitocore.org]", "www.nitocore.org", 0));
    BOOST_CHECK(TestSplitHost("www.nitocore.org:80", "www.nitocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.nitocore.org]:80", "www.nitocore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.nitocore.org:65536", "www.nitocore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.nitocore.org:0", "www.nitocore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.nitocore.org:", "www.nitocore.org:", 0, false));
}
