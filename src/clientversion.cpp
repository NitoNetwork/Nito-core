 ...
 * for both nitod and nito-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Nito");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/nito/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Nito Core copyright is not removed by accident
    if (copyright_devs.find("Nito Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Nito Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/NitoNetwork>";
