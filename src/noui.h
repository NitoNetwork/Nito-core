...
/** Connect all nitod signal handlers */
void noui_connect();

/** Redirect all nitod signal handlers to LogPrintf. Used to check or suppress output during test runs that produce expected errors */
