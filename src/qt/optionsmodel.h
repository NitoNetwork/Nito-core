...
/** Interface from Qt to configuration data structure for Nito client.
...
public:
    ...
    NitoUnit getDisplayUnit() const { return m_display_nito_unit; }
...
Q_SIGNALS:
    void displayUnitChanged(NitoUnit unit);
