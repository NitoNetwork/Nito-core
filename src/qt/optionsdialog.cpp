      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->nitoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->nitoAtStartup);
    ...
    ui->nitoAtStartup->setToolTip(ui->nitoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->nitoAtStartup->setText(ui->nitoAtStartup->text().arg(PACKAGE_NAME));

    ui->openNitoConfButton->setToolTip(ui->openNitoConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new NitoUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->nitoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNitoConfButton_clicked()
{
