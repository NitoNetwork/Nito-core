...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, NitoUnits::SeparatorStyle separators=NitoUnits::SeparatorStyle::STANDARD) const;
