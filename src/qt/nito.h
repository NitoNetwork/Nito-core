...
/** Main Nito application object */
class NitoApplication: public QApplication
{
    Q_OBJECT
public:
    explicit NitoApplication();
    ~NitoApplication();
    ...
    /// Get window identifier of QMainWindow (NitoGUI)
...
Q_SIGNALS:
    ...
    void windowShown(NitoGUI* window);
