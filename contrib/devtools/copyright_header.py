...
Arguments:
    <base_directory> - The base directory of a nito source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Nito Core developers'
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Nito Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the nito repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Nito
