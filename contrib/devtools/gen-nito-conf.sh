...
BITCOIND=${BITCOIND:-$BINDIR/nitod}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/nito.conf}
...
then
  ...
  echo -e "To safely generate a nito.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example nito.conf file in share/examples/'
...
##
## nito.conf configuration file.
## Generated by contrib/devtools/gen-nito-conf.sh.
##
...
# parse the output from nitod --help
