# Bootstrappable Nito Core Builds

This directory contains the files necessary to perform bootstrappable Nito
Core builds.
...
To build Nito Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/nito-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/nito-core/guix.sigs).
