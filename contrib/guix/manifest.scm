...
(define* (make-nito-cross-toolchain target
                                       #:key
...
desirable for building Nito Core release binaries."
...
;; failure; see https://github.com/nito/nito/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-nito-cross-toolchain target)))
