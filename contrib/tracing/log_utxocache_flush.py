...
"""Example logging Nito Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/nitod
...
def main(nitod_path):
    ...
    b = BPF(text=program, usdt_contexts=[nitod_with_usdts])
