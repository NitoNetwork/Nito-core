...
complete --command nitod --no-files

# Extract options
function __fish_nitod_get_options
...
complete \
    --command nitod \
    --arguments "(__fish_nitod_get_options --nofiles)"
