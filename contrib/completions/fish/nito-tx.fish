...
# Extract options
function __fish_nito_tx_get_options
...
# Extract commands
function __fish_nito_tx_get_commands
...
complete \
    --command nito-tx \
    --condition "not __fish_nito_seen_cmd (__fish_nito_tx_get_commands --commandsonly)" \
    --arguments "(__fish_nito_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command nito-tx \
    --arguments "(__fish_nito_tx_get_commands)" \
    --no-files
