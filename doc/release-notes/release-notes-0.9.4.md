Nito Core version 0.9.4 is now available from:

  https://nito.org/bin/0.9.4/
...
this update is incompatible with the Nito system and could lead to consensus
forks.

Nito Core released binaries from https://nito.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~nito/+archive/ubuntu/nito
- A third-party or self-compiled Nito Core

upgrade to Nito Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
