Nito Core version 0.14.2 is now available from:

  <https://nito.org/bin/nito-core-0.14.2/>
...
(in Nito Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate nito-config.h as necessary (theuni)
