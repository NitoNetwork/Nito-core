Nito-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/nito/files/Nito/nito-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Nito
...
New/changed settings (command-line or nito.conf file)
--------------------------------------------------------
