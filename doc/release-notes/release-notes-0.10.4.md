Nito Core version 0.10.4 is now available from:

  <https://nito.org/bin/nito-core-0.10.4/>
...
- #6953 `43c2789` Split nito-tx into its own package
- #6953 `dfe0d4d` Include nito-tx binary on Debian/Ubuntu
