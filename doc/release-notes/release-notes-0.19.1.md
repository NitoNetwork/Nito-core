...
Nito Core version 0.19.1 is now available from:

  <https://nitocore.org/bin/nito-core-0.19.1/>
...
From Nito Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Nito Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Nito Core does not yet change appearance when
...
- #17488 fix "nitod already running" warnings on macOS (fanquake)
