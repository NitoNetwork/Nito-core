Nito Core version 0.13.2 is now available from:

  <https://nito.org/bin/nito-core-0.13.2/>
...
- #8908 `4a974b2` Update nito-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nito-tx to create v2 transactions (btcdrak)
