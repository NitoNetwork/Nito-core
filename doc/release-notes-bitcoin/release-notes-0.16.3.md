Nito Core version 0.16.3 is now available from:

  <https://nitocore.org/bin/nito-core-0.16.3/>
...
been discovered in Nito Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` nitoconsensus: invalid flags error should be set to `nitoconsensus_err` (afk11)
