Nito version 0.5.4 is now available for download at:
http://sourceforge.net/projects/nito/files/Nito/nito-0.5.4/
...
http://gitorious.org/nito/nitod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Nito-Qt notifications under Growl 1.3.
Increase required age of Nito-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNito properly when installing Nito-Qt over it. (Windows)
