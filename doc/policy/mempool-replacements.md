...
1. The directly conflicting transactions all signal replaceability explicitly. A transaction is
   ...
   *Rationale*: See [BIP125
   explanation](https://github.com/nito/bips/blob/master/bip-0125.mediawiki#motivation).
...
* Opt-in full replace-by-fee (without inherited signaling) honoured in mempool and mining as of
  **v0.12.0** ([PR 6871](https://github.com/nito/nito/pull/6871)).

* [BIP125](https://github.com/nito/bips/blob/master/bip-0125.mediawiki) defined based on
  Nito Core implementation.
